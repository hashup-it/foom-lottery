...
// import { mimicMerkleTree } from './utils/mimcMerkleTree'
...
//   const zero = leBufferToBigint(
//     mimcsponge.F.fromMontgomery(mimcsponge.multiHash([foom, 0]))
//   );
//   const one = leBufferToBigint(
//     mimcsponge.F.fromMontgomery(mimcsponge.multiHash([1, 0xf + 1]))
//   );
