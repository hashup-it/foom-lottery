...
export async function generateWithdraw(inputs) {
  ...
  const mask =
    power <= power1
      ? ((2n ** (power1 + power2 + 1n) - 1n) << power) &
        (2n ** (power1 + power2 + 1n) - 1n)
      : (((2n ** power2 - 1n) << (power + power1)) | (2n ** power1 - 1n)) &
        (2n ** (power1 + power2 + 1n) - 1n)
  ...
  const reward3 =
    dice & 0b111111111111111111111100000000000000000000000000n ? 0n : 1n
