...
# NOTE: This should be the same on frontend (!), but in the form of IndexedDB instead; API has this code and does the same, so this can be done here too. As init. Though this can be just fetched from API and only cached afterwards.
